# 4.25:  Compare a set to a list.

# Given the below code which shows several operations that are
# possible with a list, change the list to a set (replace the
# square brackets with curly braces in the first line) and re-
# run the code to see what operations may be possible with a
# tuple.
# 
