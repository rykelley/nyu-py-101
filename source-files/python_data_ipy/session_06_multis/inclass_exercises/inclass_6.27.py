# 6.27:  Review:  trap a "bad dict key" error.  If the user's
# key can't be found in the dict, an error occurs -- test this
# by inputting a key of 'XXX'.  Once you have observed the
