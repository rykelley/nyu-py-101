# 3.7:  new program:  open the FF_abbreviated file and looping
# line-by-line, split each line so the individual columns are
# separated into a list. print the list from each line.
# (Hint:  the string split() method without any argument
